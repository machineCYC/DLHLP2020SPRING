...
if __name__ == '__main__':
    ...
    parser.add_argument('-attr', '-a', default="./model/pretrain/attr.ckpt", help='attr file path')
    parser.add_argument('-config', '-c', default="config.yaml", help='config file path')
    parser.add_argument('-model', '-m', default="./model/pretrain/vctk_model.ckpt", help='model path')
